...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(39), __webpack_require__(31)(module)))
...
var _session_reducer = __webpack_require__(80);
...
var _session_actions = __webpack_require__(148);
...
var logout = exports.logout = function logout() {
  return function (dispatch) {
    return SessionApiUtil.logout().then(function () {
      return receiveCurrentUser(null);
    });
  };
};
